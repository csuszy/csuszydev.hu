...
// hoeses
document.getElementById('hoswitch').addEventListener("change", function (e) {
    let hoswitch = document.getElementById('hoswitch').checked;
    if (hoswitch == true) {
        ...
        function render(now) {
            ...
            ctx.fillStyle = ctx.strokeStyle = '#d4dcff'
